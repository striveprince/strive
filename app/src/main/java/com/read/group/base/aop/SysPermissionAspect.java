package com.read.group.base.aop;
...
public class SysPermissionAspect {
    ...
    @Around("execution(@com.read.group.base.aop.Permission * *(..)) && @annotation(permission)")
    public void aroundJoinPoint(ProceedingJoinPoint joinPoint, Permission permission) throws Throwable {
        AppCompatActivity ac = (AppCompatActivity) ReadApplication.getApp().getCurrentActivity();
